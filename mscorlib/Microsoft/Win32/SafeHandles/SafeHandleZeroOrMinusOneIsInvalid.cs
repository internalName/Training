...
namespace Microsoft.Win32.SafeHandles
{
  ...
  {
    /// <summary>
    ///   Инициализирует новый экземпляр <see cref="T:Microsoft.Win32.SafeHandles.SafeHandleZeroOrMinusOneIsInvalid" /> класса, указывающее, является ли дескриптор освобождается надежно.
    /// </summary>
