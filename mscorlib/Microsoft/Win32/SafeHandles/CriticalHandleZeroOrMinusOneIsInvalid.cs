...
{
  /// <summary>
  ///   Предоставляет базовый класс для реализаций критического дескриптора Win32, в которых значение 0 или -1 обозначает недопустимый дескриптор.
  /// </summary>
  [SecurityCritical]
  ...
  {
    /// <summary>
    ///   Инициализирует новый экземпляр класса <see cref="T:Microsoft.Win32.SafeHandles.CriticalHandleZeroOrMinusOneIsInvalid" />.
    /// </summary>
