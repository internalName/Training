  ...
  internal static class Win32Native
  {
    ...
    internal struct WIN32_FIND_DATA
    {
      ...
      internal unsafe string cFileName
      {
        get
        {
          fixed (char* chPtr = &this._cFileName.FixedElementField)
      ...
      internal unsafe bool IsRelativeDirectory
      {
        get
        {
          fixed (char* chPtr = &this._cFileName.FixedElementField)
          {
            if (*chPtr != '.')
              return false;
            switch ((char) *(ushort*) ((IntPtr) chPtr + 2))
            {
              case char.MinValue:
                return true;
              case '.':
                return chPtr[2] == char.MinValue;
              default:
                return false;
            }
          }
      ...
      internal bool IsNormalDirectory
      {
        get
        {
          if ((this.dwFileAttributes & 16) != 0)
            return !this.IsRelativeDirectory;
          return false;
        }
      }
    }
