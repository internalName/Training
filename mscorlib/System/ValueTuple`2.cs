...
namespace System
{
  /// <summary>Представляет кортеж значений с 2 компонентами.</summary>
  /// <typeparam name="T1">
  ...
  {
    /// <summary>
    ///   Получает значение первого элемента текущего экземпляра <see cref="T:System.ValueTuple`2" />.
    /// </summary>
    /// <returns>
    ///   Значение первого элемента текущего экземпляра <see cref="T:System.ValueTuple`2" />.
    /// </returns>
    public T1 Item1;
    /// <summary>
    ///   Получает значение второго элемента текущего экземпляра <see cref="T:System.ValueTuple`2" />.
    /// </summary>
    /// <returns>
    ///   Значение второго элемента текущего экземпляра <see cref="T:System.ValueTuple`2" />.
    /// </returns>
    public T2 Item2;

    /// <summary>
    ///   Инициализирует новый экземпляр класса <see cref="T:System.ValueTuple`2" />.
    /// </summary>
    ...
    /// <summary>
    ///   Возвращает значение, показывающее, равен ли текущий экземпляр <see cref="T:System.ValueTuple`2" /> указанному объекту.
    /// </summary>
    /// <param name="obj">
    ...
    public override bool Equals(object obj)
    {
      if (obj is ValueTuple<T1, T2>)
        return this.Equals((ValueTuple<T1, T2>) obj);
      return false;
    }

    /// <summary>
    ///   Возвращает значение, показывающее, равен ли текущий экземпляр <see cref="T:System.ValueTuple`2" /> указанному экземпляру <see cref="T:System.ValueTuple`2" />.
    /// </summary>
    /// <param name="other">
    ...
    bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer)
    {
      ...
      if (comparer.Equals((object) this.Item1, (object) valueTuple.Item1))
        return comparer.Equals((object) this.Item2, (object) valueTuple.Item2);
      return false;
    }
    ...
    /// <summary>
    ///   Сравнивает текущий экземпляр <see cref="T:System.ValueTuple`2" /> с указанным экземпляром <see cref="T:System.ValueTuple`2" />.
    /// </summary>
    /// <param name="other">
    ///   Кортеж значений для сравнения с этим экземпляром.
    /// </param>
    ...
    int IStructuralComparable.CompareTo(object other, IComparer comparer)
    {
      ...
      if (num != 0)
        return num;
      return comparer.Compare((object) this.Item2, (object) valueTuple.Item2);
    }

    /// <summary>
    ///   Вычисляет хэш-код для текущего экземпляра <see cref="T:System.ValueTuple`2" />.
    /// </summary>
    /// <returns>
    ///   Хэш-код для текущего экземпляра <see cref="T:System.ValueTuple`2" />.
    /// </returns>
    ...
    {
      return ValueTuple.CombineHashCodes(comparer.GetHashCode((object) this.Item1), comparer.GetHashCode((object) this.Item2));
    }
    ...
    /// <summary>
    ///   Возвращает строковое представление значения этого экземпляра <see cref="T:System.ValueTuple`2" />.
    /// </summary>
    /// <returns>
