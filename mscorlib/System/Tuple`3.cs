...
namespace System
{
  ...
  public class Tuple<T1, T2, T3> : IStructuralEquatable, IStructuralComparable, IComparable, ITupleInternal, ITuple
  {
    ...
    /// <summary>
    ///   Возвращает значение текущего <see cref="T:System.Tuple`3" /> компонента первого объекта.
    /// </summary>
    /// <returns>
    ///   Значение текущего <see cref="T:System.Tuple`3" /> компонента первого объекта.
    /// </returns>
    [__DynamicallyInvokable]
    public T1 Item1
    {
    ...
    /// <summary>
    ///   Возвращает значение текущего <see cref="T:System.Tuple`3" /> компонента второго объекта.
    /// </summary>
    /// <returns>
    ///   Значение текущего <see cref="T:System.Tuple`3" /> компонента второго объекта.
    /// </returns>
    [__DynamicallyInvokable]
    public T2 Item2
    {
    ...
    /// <summary>
    ///   Возвращает значение текущего <see cref="T:System.Tuple`3" /> третьего компонента объекта.
    /// </summary>
    /// <returns>
    ///   Значение текущего <see cref="T:System.Tuple`3" /> третьего компонента объекта.
    /// </returns>
    [__DynamicallyInvokable]
    public T3 Item3
    {
    ...
    /// <summary>
    ///   Инициализирует новый экземпляр класса <see cref="T:System.Tuple`3" />.
    /// </summary>
    ...
    /// <summary>
    ///   Возвращает значение, указывающее, является ли текущий <see cref="T:System.Tuple`3" /> объект равен указанному объекту.
    /// </summary>
    /// <param name="obj">
    ...
    /// <summary>
    ///   Возвращает хэш-код для текущего объекта <see cref="T:System.Tuple`3" />.
    /// </summary>
    /// <returns>
    ...
    /// <summary>
    ///   Возвращает строку, представляющую значение этой <see cref="T:System.Tuple`3" /> экземпляра.
    /// </summary>
    /// <returns>
    ///   Строковое представление <see cref="T:System.Tuple`3" /> объекта.
    /// </returns>
    [__DynamicallyInvokable]
