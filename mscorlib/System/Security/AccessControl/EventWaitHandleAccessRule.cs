...
namespace System.Security.AccessControl
{
  ...
  {
    /// <summary>
    ///   Инициализирует новый экземпляр <see cref="T:System.Security.AccessControl.EventWaitHandleAccessRule" /> класс, указав пользователя или группу, относится правило, права доступа и ли указанные права доступа разрешен или запрещен.
    /// </summary>
    /// <param name="identity">
    ...
    ///   Побитовое сочетание <see cref="T:System.Security.AccessControl.EventWaitHandleRights" /> значения, указывающие права разрешен или запрещен.
    /// </param>
    /// <param name="type">
    ...
    /// <summary>
    ///   Инициализирует новый экземпляр <see cref="T:System.Security.AccessControl.EventWaitHandleAccessRule" /> класс, указав имя пользователя или группы, относится правило, права доступа и ли указанные права доступа разрешен или запрещен.
    /// </summary>
    /// <param name="identity">
    ...
    /// </summary>
    /// <returns>
    ///   Побитовое сочетание <see cref="T:System.Security.AccessControl.EventWaitHandleRights" /> значения, указывающие права разрешаются или запрещаются в правило доступа.
    /// </returns>
