...
namespace System.Security.AccessControl
{
  ...
  {
    /// <summary>
    ///   Инициализирует новый экземпляр <see cref="T:System.Security.AccessControl.MutexAuditRule" /> с указанием пользователя или группы для аудита, прав для аудита и следует ли проводить аудит успехов и сбоев.
    /// </summary>
    /// <param name="identity">
    ...
    ///   Побитовое сочетание <see cref="T:System.Security.AccessControl.MutexRights" /> значения, указывающие типы доступа для аудита.
    /// </param>
    /// <param name="flags">
    ...
    /// <returns>
    ///   Побитовое сочетание <see cref="T:System.Security.AccessControl.MutexRights" /> значений, указывающих права, применяется правило аудита.
    /// </returns>
