...
{
  /// <summary>
  ///   Вычисляет <see cref="T:System.Security.Cryptography.SHA384" /> хэш для входных данных с помощью управляемой библиотеки.
  /// </summary>
  [ComVisible(true)]
  public class SHA384Managed : SHA384
  {
    ...
    /// <summary>
    ///   Инициализирует новый экземпляр класса <see cref="T:System.Security.Cryptography.SHA384Managed" />.
    /// </summary>
    ...
    /// <summary>
    ///   Инициализирует экземпляр <see cref="T:System.Security.Cryptography.SHA384Managed" />.
    /// </summary>
    ...
    /// <summary>
    ///   При переопределении в производном классе, передает данные, записанные в объект, в <see cref="T:System.Security.Cryptography.SHA384Managed" /> хэш-алгоритма для вычисления хэша.
    /// </summary>
