...
namespace System
{
  /// <summary>Представляет кортеж значений с 5 компонентами.</summary>
  /// <typeparam name="T1">
  ...
  {
    /// <summary>
    ///   Получает значение первого элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    /// <returns>
    ///   Значение первого элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </returns>
    public T1 Item1;
    /// <summary>
    ///   Получает значение второго элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    /// <returns>
    ///   Значение второго элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </returns>
    public T2 Item2;
    /// <summary>
    ///   Получает значение третьего элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    /// <returns>
    ///   Значение третьего элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </returns>
    public T3 Item3;
    /// <summary>
    ///   Получает значение четвертого элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    /// <returns>
    ///   Значение четвертого элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </returns>
    public T4 Item4;
    /// <summary>
    ///   Получает значение пятого элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    /// <returns>
    ///   Значение пятого элемента текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </returns>
    public T5 Item5;

    /// <summary>
    ///   Инициализирует новый экземпляр класса <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    ...
    /// <summary>
    ///   Возвращает значение, показывающее, равен ли текущий экземпляр <see cref="T:System.ValueTuple`5" /> указанному объекту.
    /// </summary>
    /// <param name="obj">
    ...
    public override bool Equals(object obj)
    {
      if (obj is ValueTuple<T1, T2, T3, T4, T5>)
        return this.Equals((ValueTuple<T1, T2, T3, T4, T5>) obj);
      return false;
    }

    /// <summary>
    ///   Возвращает значение, показывающее, равен ли текущий экземпляр <see cref="T:System.ValueTuple`5" /> указанному экземпляру <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    /// <param name="other">
    ...
    {
      if (EqualityComparer<T1>.Default.Equals(this.Item1, other.Item1) && EqualityComparer<T2>.Default.Equals(this.Item2, other.Item2) && (EqualityComparer<T3>.Default.Equals(this.Item3, other.Item3) && EqualityComparer<T4>.Default.Equals(this.Item4, other.Item4)))
        return EqualityComparer<T5>.Default.Equals(this.Item5, other.Item5);
      return false;
    }
    ...
    bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer)
    {
      ...
      if (comparer.Equals((object) this.Item1, (object) valueTuple.Item1) && comparer.Equals((object) this.Item2, (object) valueTuple.Item2) && (comparer.Equals((object) this.Item3, (object) valueTuple.Item3) && comparer.Equals((object) this.Item4, (object) valueTuple.Item4)))
        return comparer.Equals((object) this.Item5, (object) valueTuple.Item5);
      return false;
    }
    ...
    /// <summary>
    ///   Сравнивает текущий экземпляр <see cref="T:System.ValueTuple`5" /> с указанным экземпляром <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    /// <param name="other">
    ///   Кортеж значений для сравнения с этим экземпляром.
    /// </param>
    ...
    int IStructuralComparable.CompareTo(object other, IComparer comparer)
    {
      ...
      if (num4 != 0)
        return num4;
      return comparer.Compare((object) this.Item5, (object) valueTuple.Item5);
    }

    /// <summary>
    ///   Вычисляет хэш-код для текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    /// <returns>
    ///   Хэш-код для текущего экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </returns>
    ...
    {
      return ValueTuple.CombineHashCodes(comparer.GetHashCode((object) this.Item1), comparer.GetHashCode((object) this.Item2), comparer.GetHashCode((object) this.Item3), comparer.GetHashCode((object) this.Item4), comparer.GetHashCode((object) this.Item5));
    }
    ...
    /// <summary>
    ///   Возвращает строковое представление значения этого экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </summary>
    /// <returns>
    ///   Строковое представление этого экземпляра <see cref="T:System.ValueTuple`5" />.
    /// </returns>
