...
{
  /// <summary>
  ///   Предоставляет <see cref="T:System.Reflection.Emit.TypeBuilder" /> класс в неуправляемый код.
  /// </summary>
  ...
  public interface _TypeBuilder
  {
    ...
    /// </summary>
    /// <param name="pcTInfo">
    ///   Если это действительно выходного параметра, как показано выше синтаксис, название должно быть здесь «при возвращении данного метода содержит указатель, к которому записывается число предоставляемых объектом интерфейсов сведения о типе.
