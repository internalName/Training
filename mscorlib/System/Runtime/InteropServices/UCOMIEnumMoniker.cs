...
{
  /// <summary>
  ///   Взамен рекомендуется использовать <see cref="T:System.Runtime.InteropServices.ComTypes.IEnumMoniker" />.
  /// </summary>
  ...
  public interface UCOMIEnumMoniker
  {
    ...
    /// </param>
    /// <param name="rgelt">
    ///   При удачном возвращении ссылку на перечисленные моникеры.
    /// </param>
    /// <param name="pceltFetched">
    ///   При удачном возвращении — ссылка на фактическое число моникеров, перечисленных в <paramref name="rgelt" />.
    /// </param>
    /// <returns>
