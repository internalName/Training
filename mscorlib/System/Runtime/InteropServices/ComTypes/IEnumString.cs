...
{
  /// <summary>
  ///   Управляет определением <see langword="IEnumString" /> интерфейса.
  /// </summary>
  ...
  public interface IEnumString
  {
    ...
    /// </param>
    /// <param name="rgelt">
    ///   При возвращении данного метода содержит ссылку на перечисленные строки.
    ///    Этот параметр передается неинициализированным.
    /// </param>
    /// <param name="pceltFetched">
    ///   При возвращении данного метода содержит ссылку на фактическое число строк, перечисленных в <paramref name="rgelt" />.
    /// </param>
    /// <returns>
