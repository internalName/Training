...
{
  /// <summary>
  ///   Описывает исходные параметры <see cref="T:System.Runtime.InteropServices.VARFLAGS" /> в библиотеке типов COM, из которой была импортирована эта переменная.
  /// </summary>
  [Flags]
  [ComVisible(true)]
  [Serializable]
