  ...
  internal sealed class __BinaryParser
  {
        ...
        while (flag1)
        {
          ...
          if (binaryHeaderEnum != BinaryHeaderEnum.Assembly)
          {
            ...
            while (!flag2)
            {
              ...
              {
                flag2 = op.GetNext(out op.expectedType, out op.expectedTypeInformation);
      ...
      else
      {
        ...
        switch (objectProgress.objectTypeEnum)
        {
          ...
          case InternalObjectTypeE.Array:
            ...
            break;
          default:
            throw new SerializationException(Environment.GetResourceString("Serialization_Map", (object) objectProgress.objectTypeEnum.ToString()));
        }
      }
    ...
    private void ReadArray(BinaryHeaderEnum binaryHeaderEnum)
    {
      ...
      if (binaryArray.binaryTypeEnum == BinaryTypeEnum.ObjectUser)
      {
        ...
        systemAssemblyInfo = (BinaryAssemblyInfo) this.AssemIdToAssemblyTable[binaryArray.assemId];
      }
      else
      ...
      BinaryConverter.TypeFromInfo(binaryArray.binaryTypeEnum, binaryArray.typeInformation, this.objectReader, systemAssemblyInfo, out pr.PRarrayElementTypeCode, out pr.PRarrayElementTypeString, out pr.PRarrayElementType, out pr.PRisArrayVariant);
      pr.PRdtTypeCode = InternalPrimitiveTypeE.Invalid;
    ...
    private void ReadArrayAsBytes(ParseRecord pr)
    {
      ...
      else
      {
        ...
        {
          int num3 = Math.Min(4096 / num1, prnewObj.Length - num2);
          int num4 = num3 * num1;
          this.ReadBytes(this.byteBuffer, 0, num4);
          Buffer.InternalBlockCopy((Array) this.byteBuffer, 0, prnewObj, num2 * num1, num4);
          num2 += num3;
        }
      }
    }
