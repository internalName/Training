...
namespace System.Globalization
{
  ...
  public class TaiwanCalendar : Calendar
  {
    ...
    /// <summary>
    ///   Получает самые ранние дату и время, поддерживаемые классом <see cref="T:System.Globalization.TaiwanCalendar" />.
    /// </summary>
    /// <returns>
    ///   Минимальное значение даты и время, поддерживаемые <see cref="T:System.Globalization.TaiwanCalendar" /> класс, который эквивалентен первый момент 1 января 1912 года нашей эры в григорианском календаре.
    /// </returns>
    [ComVisible(false)]
    ...
    /// <summary>
    ///   Получает самые последние дату и время, поддерживаемые классом <see cref="T:System.Globalization.TaiwanCalendar" />.
    /// </summary>
    /// <returns>
    ///   Самые последние дату и время, поддерживаемые <see cref="T:System.Globalization.TaiwanCalendar" /> класс, который эквивалентен последний момент 31 декабря 9999 года нашей эры в григорианском календаре.
    /// </returns>
    [ComVisible(false)]
    ...
    /// <summary>
    ///   Инициализирует новый экземпляр класса <see cref="T:System.Globalization.TaiwanCalendar" />.
    /// </summary>
    /// <exception cref="T:System.TypeInitializationException">
    ///   Не удалось инициализировать <see cref="T:System.Globalization.TaiwanCalendar" /> объект из-за отсутствия язык и региональные параметры.
    /// </exception>
    ...
    /// <returns>
    ///   Возвращаемое значение всегда равно 0 из-за <see cref="T:System.Globalization.TaiwanCalendar" /> класс не поддерживает понятие високосного года.
    /// </returns>
    [ComVisible(false)]
    ...
    /// <summary>
    ///   Возвращает список эр в <see cref="T:System.Globalization.TaiwanCalendar" />.
    /// </summary>
    /// <returns>
    ///   Массив, состоящий из одного элемента, для которого значение всегда равно текущей эре.
    /// </returns>
    ...
    /// <summary>
    ///   Преобразует указанный год в четырехзначный год с помощью <see cref="P:System.Globalization.TaiwanCalendar.TwoDigitYearMax" /> Свойства для определения века.
    /// </summary>
    /// <param name="year">
