...
namespace System.Globalization
{
  ...
  public sealed class DateTimeFormatInfo : ICloneable, IFormatProvider
  {
    ...
    /// <summary>
    ///   Инициализирует новый доступный для записи экземпляр класса <see cref="T:System.Globalization.DateTimeFormatInfo" />, не зависящий от языка и региональных параметров (инвариантный).
    /// </summary>
    [__DynamicallyInvokable]
    ...
    private void OnSerializing(StreamingContext ctx)
    {
      ...
      object obj = (object) this.LongTimePattern;
      obj = (object) this.LongDatePattern;
      obj = (object) this.ShortTimePattern;
      obj = (object) this.ShortDatePattern;
      obj = (object) this.YearMonthPattern;
      obj = (object) this.AllLongTimePatterns;
      obj = (object) this.AllLongDatePatterns;
      obj = (object) this.AllShortTimePatterns;
      obj = (object) this.AllShortDatePatterns;
      obj = (object) this.AllYearMonthPatterns;
    }

    /// <summary>
    ///   Возвращает значение по умолчанию только для чтения <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект, зависящий от языка и региональных параметров (инвариантный).
    /// </summary>
    /// <returns>
    ...
    /// <summary>
    ///   Получает доступный только для чтения объект <see cref="T:System.Globalization.DateTimeFormatInfo" />, форматирующий значения на основе текущего языка и региональных параметров.
    /// </summary>
    /// <returns>
    ///   Доступный только для чтения объект <see cref="T:System.Globalization.DateTimeFormatInfo" /> на основе объекта <see cref="T:System.Globalization.CultureInfo" /> текущего потока.
    /// </returns>
    [__DynamicallyInvokable]
    ...
    /// <summary>
    ///   Возвращает <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект, связанный с указанным <see cref="T:System.IFormatProvider" />.
    /// </summary>
    /// <param name="provider">
    ///   <see cref="T:System.IFormatProvider" /> Который получает <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// 
    ///   -или-
    /// 
    ///   Значение <see langword="null" />, чтобы получить <see cref="P:System.Globalization.DateTimeFormatInfo.CurrentInfo" />.
    /// </param>
    /// <returns>
    ///   Объект <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект, связанный с <see cref="T:System.IFormatProvider" />.
    /// </returns>
    [__DynamicallyInvokable]
    public static DateTimeFormatInfo GetInstance(IFormatProvider provider)
    {
      ...
      if (provider != null)
      {
        DateTimeFormatInfo format = provider.GetFormat(typeof (DateTimeFormatInfo)) as DateTimeFormatInfo;
        if (format != null)
          return format;
      }
    ...
    ///   Тип требуемой службы форматирования.
    /// </param>
    /// <returns>
    ///   Текущий объект, если <paramref name="formatType" /> совпадает с типом текущего <see cref="T:System.Globalization.DateTimeFormatInfo" />; в противном случае — <see langword="null" />.
    /// </returns>
    [__DynamicallyInvokable]
    ...
    /// <summary>
    ///   Создает неполную копию объекта <see cref="T:System.Globalization.DateTimeFormatInfo" />.
    /// </summary>
    /// <returns>
    ///   Новый <see cref="T:System.Globalization.DateTimeFormatInfo" /> скопированный из исходного объекта <see cref="T:System.Globalization.DateTimeFormatInfo" />.
    /// </returns>
    [__DynamicallyInvokable]
    public object Clone()
    {
    ...
    /// </summary>
    /// <returns>
    ///   Строка указателя часов до полудня.
    ///    Значение по умолчанию для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> — «AM».
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   Свойство установлено и <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект доступен только для чтения.
    /// </exception>
    [__DynamicallyInvokable]
    ...
    /// </summary>
    /// <returns>
    ///   Календарь, используемый в текущем языке и региональных параметрах.
    ///    Значение по умолчанию для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> — <see cref="T:System.Globalization.GregorianCalendar" /> объекта.
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   Устанавливается свойство <see cref="T:System.Globalization.Calendar" /> объекта, который не является допустимым для текущего языка и региональных параметров.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   Для свойства задается значение, а объект <see cref="T:System.Globalization.DateTimeFormatInfo" /> доступен только для чтения.
    /// </exception>
    [__DynamicallyInvokable]
    ...
    /// <returns>
    ///   Целое число, представляющее эру, если <paramref name="eraName" /> является допустимым; в противном случае — значение -1.
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Свойство <paramref name="eraName" /> имеет значение <see langword="null" />.
    /// </exception>
    [__DynamicallyInvokable]
    public int GetEra(string eraName)
    {
      if (eraName == null)
        throw new ArgumentNullException(nameof (eraName), Environment.GetResourceString("ArgumentNull_String"));
      if (eraName.Length == 0)
        return -1;
    ...
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   <paramref name="era" /> не представляет допустимый эры в календаре, определенном в <see cref="P:System.Globalization.DateTimeFormatInfo.Calendar" /> свойство.
    /// </exception>
    [__DynamicallyInvokable]
    ...
    /// <param name="era">Целое число, представляющее эру.</param>
    /// <returns>
    ///   Строка, содержащая сокращенное название указанной эры, если такое сокращение существует,
    /// 
    ///   -или-
    /// 
    ///   Строка, содержащая полное название указанной эры, если сокращение отсутствует.
    /// </returns>
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   <paramref name="era" /> не представляет допустимый эры в календаре, определенном в <see cref="P:System.Globalization.DateTimeFormatInfo.Calendar" /> свойство.
    /// </exception>
    ...
    /// </summary>
    /// <returns>
    ///   Строка, разделяющая компоненты даты — год, месяц и день.
    ///    Значение по умолчанию для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> — «/».
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    ...
    ///    Значение по умолчанию для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> — <see cref="F:System.DayOfWeek.Sunday" />.
    /// </returns>
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   Свойство задано значение, не является допустимым <see cref="T:System.DayOfWeek" /> значение.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   Для свойства задается значение, а объект <see cref="T:System.Globalization.DateTimeFormatInfo" /> доступен только для чтения.
    /// </exception>
    ...
    public DayOfWeek FirstDayOfWeek
    {
      ...
      [__DynamicallyInvokable] set
      {
        ...
        if (value >= DayOfWeek.Sunday && value <= DayOfWeek.Saturday)
          ...
          throw new ArgumentOutOfRangeException(nameof (value), Environment.GetResourceString("ArgumentOutOfRange_Range", (object) DayOfWeek.Sunday, (object) DayOfWeek.Saturday));
      }
    }
    ...
    /// </summary>
    /// <returns>
    ///   Значение, определяющее первую календарную неделю года.
    ///    Значение по умолчанию для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> — <see cref="F:System.Globalization.CalendarWeekRule.FirstDay" />.
    /// </returns>
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   Свойство задано значение, не является допустимым <see cref="T:System.Globalization.CalendarWeekRule" /> значение.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   В наборе операций текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект доступен только для чтения.
    /// </exception>
    [__DynamicallyInvokable]
    public CalendarWeekRule CalendarWeekRule
    {
      ...
      [__DynamicallyInvokable] set
      {
        ...
        if (value >= CalendarWeekRule.FirstDay && value <= CalendarWeekRule.FirstFourDayWeek)
          ...
          throw new ArgumentOutOfRangeException(nameof (value), Environment.GetResourceString("ArgumentOutOfRange_Range", (object) CalendarWeekRule.FirstDay, (object) CalendarWeekRule.FirstFourDayWeek));
      }
    }
    ...
    /// </summary>
    /// <returns>
    ///   Строка пользовательского формата для длинного значения даты и длинного значения времени.
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    ...
    /// </summary>
    /// <returns>
    ///   Строка пользовательского формата для длинного значения даты.
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    ...
    /// </summary>
    /// <returns>
    ///   Строка указателя часов после полудня (PМ — "post meridiem").
    ///    Значение по умолчанию для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> — «PM».
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    ...
    /// </summary>
    /// <returns>
    ///   Строка пользовательского формата для значения времени на основе спецификации 1123 IETF RFC.
    /// </returns>
    [__DynamicallyInvokable]
    ...
    /// </summary>
    /// <returns>
    ///   Строка пользовательского формата для короткого значения времени.
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    ...
    /// </summary>
    /// <returns>
    ///   Строка пользовательского формата для сортируемого значения даты и времени.
    /// </returns>
    [__DynamicallyInvokable]
    ...
    /// </summary>
    /// <returns>
    ///   Строка, разделяющая компоненты времени.
    ///    Значение по умолчанию для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> — «:».
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    ...
    /// <summary>
    ///   Получает строку пользовательского формата для универсальной, сортируемой строки даты и времени.
    /// </summary>
    /// <returns>
    ...
    /// </summary>
    /// <returns>
    ///   Строка пользовательского формата для значения года и месяца.
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    ...
    /// <summary>
    ///   Возвращает или задает одномерный массив типа <see cref="T:System.String" /> содержащий региональных сокращенные названия дней недели.
    /// </summary>
    /// <returns>
    ///   Одномерный массив типа <see cref="T:System.String" /> содержащий региональных сокращенные названия дней недели.
    ///    Массив для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> содержит «Sun», «Понедельник», «Вторник», «Среда», «Четверг», «Пт» и «Sat».
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    /// <exception cref="T:System.ArgumentException">
    ///   Свойство задано в массив, многомерные или длина, не равна 7.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   Свойство установлено и <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект доступен только для чтения.
    /// </exception>
    ...
    public string[] AbbreviatedDayNames
    {
      ...
      [__DynamicallyInvokable] set
      {
        if (this.IsReadOnly)
          throw new InvalidOperationException(Environment.GetResourceString("InvalidOperation_ReadOnly"));
        if (value == null)
          throw new ArgumentNullException(nameof (value), Environment.GetResourceString("ArgumentNull_Array"));
        if (value.Length != 7)
          throw new ArgumentException(Environment.GetResourceString("Argument_InvalidArrayLength", (object) 7), nameof (value));
    ...
    /// <summary>
    ///   Возвращает или задает массив строк кратчайший уникальный сокращенные названия, связанных с текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// </summary>
    /// <returns>Массив строк имен дней.</returns>
    /// <exception cref="T:System.ArgumentException">
    ///   В наборе операций массив не имеет ровно семь элементов.
    /// </exception>
    /// <exception cref="T:System.ArgumentNullException">
    ///   В наборе операций массив значений или один из элементов массива значений является <see langword="null" />.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   В наборе операций текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект доступен только для чтения.
    /// </exception>
    ...
    /// </summary>
    /// <returns>
    ///   Одномерный массив строк, содержащий полные названия дней недели, принятые в определенном языке и региональных параметрах.
    ///    Массив для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> содержит «Воскресенье», «Понедельник», «Вторник», «Среда», «Четверг», «Пятница» и «Воскресенье».
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    ...
    /// </summary>
    /// <returns>
    ///   Одномерный строковый массив, состоящий из 13 элементов и содержащий сокращения месяцев, принятые в определенном языке и региональных параметрах.
    ///    В 12-месячных календарях тринадцатый элемент массива представляет собой пустую строку.
    ///    Массив для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> содержит «Января», «Февраль», «Мар», «Апр», «Май», «Июн», «Июл», «Авг», «Сен», «Окт», «Ноября», «Дек» и «».
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    /// <exception cref="T:System.ArgumentException">
    ///   Свойство задано в массив, многомерные или длина, не точно 13.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   Свойство установлено и <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект доступен только для чтения.
    /// </exception>
    ...
    public string[] AbbreviatedMonthNames
    {
      ...
      [__DynamicallyInvokable] set
      {
        ...
        if (value == null)
          throw new ArgumentNullException(nameof (value), Environment.GetResourceString("ArgumentNull_Array"));
        if (value.Length != 13)
          throw new ArgumentException(Environment.GetResourceString("Argument_InvalidArrayLength", (object) 13), nameof (value));
    ...
    /// <summary>
    ///   Возвращает или задает одномерный массив типа <see cref="T:System.String" /> содержащий полный в определенном языке и региональных параметрах.
    /// </summary>
    /// <returns>
    ///   Одномерный массив типа <see cref="T:System.String" /> содержащий полный в определенном языке и региональных параметрах.
    ///    В 12-месячном календаре тринадцатый элемент массива представляет собой пустую строку.
    ///    Массив для <see cref="P:System.Globalization.DateTimeFormatInfo.InvariantInfo" /> содержит «Январь», «Февраль», «Март», «Апрель», «Май», «Июнь», «Июль», «Август», «Сентябрь», «Октябрь», «Ноября», «Декабрь» и «».
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Для свойства задается значение <see langword="null" />.
    /// </exception>
    ...
    internal string internalGetMonthName(int month, MonthNameStyles style, bool abbreviated)
    {
      ...
      if (month < 1 || month > strArray.Length)
        throw new ArgumentOutOfRangeException(nameof (month), Environment.GetResourceString("ArgumentOutOfRange_Range", (object) 1, (object) strArray.Length));
    ...
    /// <summary>
    ///   Возвращает сокращенное название указанного дня недели, в зависимости от языка и региональных параметров, связанных с текущими региональными <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// </summary>
    /// <param name="dayofweek">
    ///   Значение <see cref="T:System.DayOfWeek" />.
    /// </param>
    /// <returns>
    ///   Сокращенное название дня недели, представленный региональных <paramref name="dayofweek" />.
    /// </returns>
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   <paramref name="dayofweek" /> не является допустимым значением <see cref="T:System.DayOfWeek" />.
    /// </exception>
    [__DynamicallyInvokable]
    public string GetAbbreviatedDayName(DayOfWeek dayofweek)
    {
      switch (dayofweek)
      {
        ...
        default:
          throw new ArgumentOutOfRangeException(nameof (dayofweek), Environment.GetResourceString("ArgumentOutOfRange_Range", (object) DayOfWeek.Sunday, (object) DayOfWeek.Saturday));
      }
    }

    /// <summary>
    ///   Получает короткое сокращенное название дня для определенного дня недели, связанное с текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// </summary>
    /// <param name="dayOfWeek">
    ///   Одно из значений <see cref="T:System.DayOfWeek" />.
    /// </param>
    /// <returns>
    ///   Сокращение для недели, соответствующее <paramref name="dayOfWeek" /> параметр.
    /// </returns>
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   <paramref name="dayOfWeek" /> не является значением в <see cref="T:System.DayOfWeek" /> перечисления.
    /// </exception>
    [ComVisible(false)]
    ...
    /// </summary>
    /// <returns>
    ///   Массив, содержащий стандартные шаблоны, в которых можно форматировать значения даты и времени.
    /// </returns>
    ...
    /// <returns>
    ///   Массив, содержащий стандартные шаблоны, в которых значения даты и времени можно форматировать с помощью указанной строки формата.
    /// </returns>
    /// <exception cref="T:System.ArgumentException">
    ///   <paramref name="format" /> не является допустимым строка стандартного формата.
    /// </exception>
    ...
    /// <summary>
    ///   Возвращает полное имя региональных указанного дня недели, в зависимости от языка и региональных параметров, связанных с текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// </summary>
    /// <param name="dayofweek">
    ///   Значение <see cref="T:System.DayOfWeek" />.
    /// </param>
    /// <returns>
    ///   Полное имя определенного языка и региональных параметров, дня недели, представленный <paramref name="dayofweek" />.
    /// </returns>
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   <paramref name="dayofweek" /> не является допустимым значением <see cref="T:System.DayOfWeek" />.
    /// </exception>
    ...
    /// <summary>
    ///   Возвращает сокращенное название указанного месяца, в зависимости от языка и региональных параметров, связанных с текущими региональными <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// </summary>
    /// <param name="month">
    ///   Целое число от 1 до 13, представляющее имя месяца для извлечения.
    /// </param>
    /// <returns>
    ///   Сокращенное название месяца, представленный региональных <paramref name="month" />.
    /// </returns>
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   <paramref name="month" /> значение меньше 1 или больше 13.
    /// </exception>
    [__DynamicallyInvokable]
    public string GetAbbreviatedMonthName(int month)
    {
      if (month < 1 || month > 13)
        throw new ArgumentOutOfRangeException(nameof (month), Environment.GetResourceString("ArgumentOutOfRange_Range", (object) 1, (object) 13));
      return this.internalGetAbbreviatedMonthNames()[month - 1];
    }

    /// <summary>
    ///   Возвращает полное имя указанного месяца, в зависимости от языка и региональных параметров, связанных с текущими региональными <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// </summary>
    /// <param name="month">
    ///   Целое число от 1 до 13, представляющее имя месяца для извлечения.
    /// </param>
    /// <returns>
    ///   Полное имя месяца, представленный региональных <paramref name="month" />.
    /// </returns>
    /// <exception cref="T:System.ArgumentOutOfRangeException">
    ///   <paramref name="month" /> значение меньше 1 или больше 13.
    /// </exception>
    ...
    /// <summary>
    ///   Возвращает программу-оболочку <see cref="T:System.Globalization.DateTimeFormatInfo" />, доступную только для чтения.
    /// </summary>
    /// <param name="dtfi">
    ///   Объект <see cref="T:System.Globalization.DateTimeFormatInfo" />, для которого создается оболочка.
    /// </param>
    /// <returns>
    ///   Только для чтения <see cref="T:System.Globalization.DateTimeFormatInfo" /> оболочки.
    /// </returns>
    /// <exception cref="T:System.ArgumentNullException">
    ///   Свойство <paramref name="dtfi" /> имеет значение <see langword="null" />.
    /// </exception>
    [__DynamicallyInvokable]
    public static DateTimeFormatInfo ReadOnly(DateTimeFormatInfo dtfi)
    {
      if (dtfi == null)
        throw new ArgumentNullException(nameof (dtfi), Environment.GetResourceString("ArgumentNull_Obj"));
      if (dtfi.IsReadOnly)
        return dtfi;
    ...
    /// <summary>
    ///   Возвращает значение, указывающее, является ли <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект доступен только для чтения.
    /// </summary>
    /// <returns>
    ///   <see langword="true" /> Если <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект только для чтения; в противном случае — <see langword="false" />.
    /// </returns>
    [__DynamicallyInvokable]
    ...
    /// <summary>
    ///   Получает собственное имя календаря, связанного с текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// </summary>
    /// <returns>
    ///   Собственное имя календаря, используемое в языке и региональных параметрах, связанных с текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта, если имя доступно, или пустая строка («»), если собственное имя календаря недоступен.
    /// </returns>
    [ComVisible(false)]
    ...
    /// </param>
    /// <param name="format">
    ///   Строка стандартного формата, связанных с помощью строк настраиваемого формата, указанного в <paramref name="patterns" /> параметре.
    /// </param>
    /// <exception cref="T:System.ArgumentException">
    ///   <paramref name="patterns" /> — <see langword="null" /> или массив нулевой длины.
    /// 
    ///   -или-
    /// 
    ///   <paramref name="format" /> не является допустимым строка стандартного формата или строка стандартного формата, образцы которых не может быть задано.
    /// </exception>
    /// <exception cref="T:System.ArgumentNullException">
    ///   <paramref name="patterns" /> содержит элемент массива, значение которого равно <see langword="null" />.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   Это <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект доступен только для чтения.
    /// </exception>
    [ComVisible(false)]
    public void SetAllDateTimePatterns(string[] patterns, char format)
    {
      if (this.IsReadOnly)
        throw new InvalidOperationException(Environment.GetResourceString("InvalidOperation_ReadOnly"));
      if (patterns == null)
        throw new ArgumentNullException(nameof (patterns), Environment.GetResourceString("ArgumentNull_Array"));
    ...
    /// <summary>
    ///   Возвращает или задает массив строк сокращенных имен месяцев связанных с текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// </summary>
    /// <returns>Массив сокращенных имен месяцев.</returns>
    /// <exception cref="T:System.ArgumentException">
    ///   В наборе операций массив является многомерным или имеет длину, не точно 13.
    /// </exception>
    /// <exception cref="T:System.ArgumentNullException">
    ///   В наборе операций массив или один из элементов массива является <see langword="null" />.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   В наборе операций текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект доступен только для чтения.
    /// </exception>
    ...
    /// <summary>
    ///   Возвращает или задает массив строк названий месяцев, связанных с текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объекта.
    /// </summary>
    ...
    /// </exception>
    /// <exception cref="T:System.ArgumentNullException">
    ///   В наборе операций массив или одного из его элементов является <see langword="null" />.
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///   В наборе операций текущим <see cref="T:System.Globalization.DateTimeFormatInfo" /> объект доступен только для чтения.
    /// </exception>
    ...
    private void InsertHash(TokenHashValue[] hashTable, string str, TokenType tokenType, int tokenValue)
    {
      ...
      do
      {
        ...
        if (str.Length >= tokenHashValue.tokenString.Length && string.Compare(str, 0, tokenHashValue.tokenString, 0, tokenHashValue.tokenString.Length, this.Culture, CompareOptions.IgnoreCase) == 0)
        {
          ...
          int num = (int) tokenType;
          int tokenType1 = (int) tokenHashValue.tokenType;
          if (DateTimeFormatInfo.preferExistingTokens || BinaryCompatibility.TargetsAtLeast_Desktop_V4_5_1)
          {
            if ((tokenType1 & (int) byte.MaxValue) == 0 && (num & (int) byte.MaxValue) != 0 || (tokenType1 & 65280) == 0 && (num & 65280) != 0)
            {
          ...
          else if (((num | tokenType1) & (int) byte.MaxValue) == num || ((num | tokenType1) & 65280) == num)
          {
            tokenHashValue.tokenType |= tokenType;
            if (tokenValue != 0)
              tokenHashValue.tokenValue = tokenValue;
